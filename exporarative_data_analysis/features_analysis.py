...
if __name__ == "__main__":
    ...
    # Example usage of the Feature Analysis with different
    ...
    # #*************************** ANALYSIS BY ITERATING FEATURES OF THE DATASAET*********************************
    # # **********************************************************************************************************
    ...
    # #*************************** ANALYSIS BY SPECIFYING FEATURES OF THE DATASAET*********************************
    # # **********************************************************************************************************

    # # analyze numerical features By SPECIFYING FEATURE
    # analyzer = FeatureAnalyzer(NumericalFeature())
